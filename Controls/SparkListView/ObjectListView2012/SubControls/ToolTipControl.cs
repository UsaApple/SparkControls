...
namespace SparkControls
{
    ...
    public class ToolTipControl : NativeWindow
    {
        ...
        internal int WindowStyle {
            get {
                return (int)NativeMethods2.GetWindowLong(this.Handle, GWL_STYLE);
            }
            set {
                NativeMethods2.SetWindowLong(this.Handle, GWL_STYLE, value);
            }
        }
        ...
        public Color BackColor {
            get {
                int color = (int)NativeMethods2.SendMessage(this.Handle, TTM_GETTIPBKCOLOR, 0, 0);
            ...
            set {
                ...
                if (!ObjectListView.IsVistaOrLater) {
                    ...
                    NativeMethods2.SendMessage(this.Handle, TTM_SETTIPBKCOLOR, color, 0);
        ...
        public Color ForeColor {
            get {
                int color = (int)NativeMethods2.SendMessage(this.Handle, TTM_GETTIPTEXTCOLOR, 0, 0);
                return ColorTranslator.FromWin32(color);
            }
            set {
                // For some reason, setting the color fails on Vista and messes up later ops.
                ...
                if (!ObjectListView.IsVistaOrLater) {
                    int color = ColorTranslator.ToWin32(value);
                    NativeMethods2.SendMessage(this.Handle, TTM_SETTIPTEXTCOLOR, color, 0);
                }
            }
        }
            ...
            set {
                if (String.IsNullOrEmpty(value))
                    ...
                    if (value.Length >= 100)
                        ...
                        this.title = value;
                NativeMethods2.SendMessageString(this.Handle, TTM_SETTITLE, (int)this.standardIcon, this.title);
            }
        }
        ...
        public Font Font {
            get {
                IntPtr hfont = NativeMethods2.SendMessage(this.Handle, WM_GETFONT, 0, 0);
            ...
            set {
                ...
                NativeMethods2.SendMessage(this.Handle, WM_SETFONT, hfont, 0);
            }
        }
        private Font font;
        ...
        private int GetDelayTime(int which) {
            return (int)NativeMethods2.SendMessage(this.Handle, TTM_GETDELAYTIME, which, 0);
        }

        private void SetDelayTime(int which, int value) {
            NativeMethods2.SendMessage(this.Handle, TTM_SETDELAYTIME, which, value);
        }
        ...
        public void AddTool(IWin32Window window) {
            NativeMethods2.TOOLINFO lParam = this.MakeToolInfoStruct(window);
            NativeMethods2.SendMessageTOOLINFO(this.Handle, TTM_ADDTOOL, 0, lParam);
        }
        ...
        public void PopToolTip(IWin32Window window) {
            NativeMethods2.SendMessage(this.Handle, TTM_POP, 0, 0);
        }
        ...
        public void RemoveToolTip(IWin32Window window) {
            NativeMethods2.TOOLINFO lParam = this.MakeToolInfoStruct(window);
            NativeMethods2.SendMessageTOOLINFO(this.Handle, TTM_DELTOOL, 0, lParam);
        }
        ...
        public void SetMaxWidth(int maxWidth) {
            NativeMethods2.SendMessage(this.Handle, TTM_SETMAXTIPWIDTH, 0, maxWidth);
        }
        ...
        private NativeMethods2.TOOLINFO MakeToolInfoStruct(IWin32Window window) {

            NativeMethods2.TOOLINFO toolinfo_tooltip = new NativeMethods2.TOOLINFO();
        ...
        public virtual bool HandleGetDispInfo(ref Message msg) {
            ...
            NativeMethods2.NMTTDISPINFO dispInfo = (NativeMethods2.NMTTDISPINFO)msg.GetLParam(typeof(NativeMethods2.NMTTDISPINFO));
        ...
        protected virtual bool HandleReflectNotify(ref Message msg) {
            ...
            NativeMethods2.NMHEADER nmheader = (NativeMethods2.NMHEADER)msg.GetLParam(typeof(NativeMethods2.NMHEADER));
            switch (nmheader.nhdr.code) {
                case TTN_SHOW:
