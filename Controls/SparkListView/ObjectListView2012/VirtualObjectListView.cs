        ...
        protected new virtual int VirtualListSize {
            ...
            set {
                ...
                if (this.IsHandleCreated && !this.DesignMode)
                    NativeMethods2.SetItemCount(this, value);
            }
        }
...
//        }
        ...
        protected override void CreateGroups(IEnumerable<OLVGroup> groups) {
            ...
            NativeMethods2.ClearGroups(this);
        ...
        protected void DisableVirtualGroups() {
            ...
            IntPtr x = NativeMethods2.SendMessage(this.Handle, LVM_ENABLEGROUPVIEW, 0, 0);
            //System.Diagnostics.Debug.WriteLine(x);

            const int LVM_SETOWNERDATACALLBACK = 0x10BB;
            IntPtr x2 = NativeMethods2.SendMessage(this.Handle, LVM_SETOWNERDATACALLBACK, 0, 0);
        ...
        protected void EnableVirtualGroups() {
            ...
            IntPtr x = NativeMethods2.SendMessage(this.Handle, LVM_SETOWNERDATACALLBACK, ptr, 0);
            //System.Diagnostics.Debug.WriteLine(x);
            Marshal.Release(ptr);

            const int LVM_ENABLEGROUPVIEW = 0x1000 + 157;
            x = NativeMethods2.SendMessage(this.Handle, LVM_ENABLEGROUPVIEW, 1, 0);
            //System.Diagnostics.Debug.WriteLine(x);
        }
