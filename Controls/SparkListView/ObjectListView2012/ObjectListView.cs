...
namespace SparkControls
{
    ...
    /// </remarks>
    [ToolboxItem(false)]
    [Designer(typeof(SparkControls.Design.ObjectListViewDesigner))]
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        [Browsable(false)]
        public virtual SparkTreeListViewTheme Theme { get; }
        ...
        /// </summary>
        [Editor("SparkControls.Design.OLVColumnCollectionEditor", "System.Drawing.Design.UITypeEditor")]
        ...
        {
            get { return this.GetFilteredColumns(System.Windows.Forms.View.Tile); }
        }
        ...
        public Rectangle ContentRectangle
        {
            get
            {
                ...
                if ((this.View == System.Windows.Forms.View.Details || this.ShowHeaderInAllViews) && this.HeaderControl != null)
                {
                    Rectangle hdrBounds = new Rectangle();
                    NativeMethods2.GetClientRect(this.HeaderControl.Handle, ref hdrBounds);
        ...
        public void DisableObjects(IEnumerable models)
        {
            ...
            foreach (object model in list)
            {
                ...
                if (modelIndex >= 0)
                    NativeMethods2.DeselectOneItem(this, modelIndex);
            }
...
// ReSharper disable FieldCanBeMadeReadOnly.Global
        ...
        public ImageList GroupImageList
        {
            ...
            set
            {
                ...
                if (this.Created)
                {
                    NativeMethods2.SetGroupImageList(this, value);
                }
            }
        }
        ...
        public virtual int RowsPerPage
        {
            get
            {
                return NativeMethods2.GetCountPerPage(this);
            }
        }
        ...
        public bool ShowHeaderInAllViews
        {
            ...
            set
            {
                ...
                {
                    System.Windows.Forms.View temp = this.View;
        ...
        private void SetGroupSpacing()
        {
            ...
            NativeMethods2.LVGROUPMETRICS metrics = new NativeMethods2.LVGROUPMETRICS();
            metrics.cbSize = ((uint)Marshal.SizeOf(typeof(NativeMethods2.LVGROUPMETRICS)));
            metrics.mask = (uint)GroupMetricsMask.LVGMF_BORDERSIZE;
            metrics.Bottom = (uint)this.SpaceBetweenGroups;
            NativeMethods2.SetGroupMetrics(this, metrics);
        }
        ...
        public virtual int TopItemIndex
        {
            get
            {
                if (this.View == System.Windows.Forms.View.Details && this.IsHandleCreated)
                    return NativeMethods2.GetTopIndex(this);
            ...
            set
            {
                ...
                if (this.View != System.Windows.Forms.View.Details || newTopIndex < 0)
                    return;
        ...
        public bool UseExplorerTheme
        {
            ...
            set
            {
                ...
                if (this.Created)
                    NativeMethods2.SetWindowTheme(this.Handle, value ? "explorer" : "", null);
        ...
        [Category("ObjectListView"),
         ...
         DefaultValue(false)]
        public virtual bool UseTranslucentHotItem
        {
            get
            {
                return useTranslucentHotItem;
            }
            set
            {
                ...
                if (value)
                {
                    ...
                    rbd.BoundsPadding = new Size(0, 0);
                    rbd.CornerRounding = 6.0f;
                    rbd.FillGradientFrom = this.Theme.SelectedBackColor;
                    rbd.FillGradientTo = this.Theme.SelectedBackColor;
        ...
        private bool useTranslucentHotItem = false;
        ...
        [Category("Appearance"),
         ...
         DefaultValue(null)]
        new public System.Windows.Forms.View View
        {
...
#pragma warning restore 168
        ...
        protected virtual void ApplyExtendedStyles()
        {
            ...
            NativeMethods2.SetExtendedStyle(this, style, STYLE_MASK);
        }
        ...
        public virtual void ChangeToFilteredColumns(System.Windows.Forms.View view)
        {
            ...
            if (view == System.Windows.Forms.View.Details || this.ShowHeaderInAllViews)
            {
        ...
        {
            NativeMethods2.DeselectAllItems(this);
        }
        ...
        {
            NativeMethods2.Scroll(this, dx, dy);
        }
        ...
        public Point LowLevelScrollPosition
        {
            get
            {
                return new Point(NativeMethods2.GetScrollPosition(this, true), NativeMethods2.GetScrollPosition(this, false));
            }
        }
        ...
        protected OlvListViewHitTestInfo LowLevelHitTest(int x, int y)
        {
            ...
            NativeMethods2.LVHITTESTINFO lParam = new NativeMethods2.LVHITTESTINFO();
            lParam.pt_x = x;
            lParam.pt_y = y;
            int index = NativeMethods2.HitTest(this, ref lParam);
            ...
            OLVListSubItem subItem = (this.View == System.Windows.Forms.View.Details && hitItem != null) ? hitItem.GetSubItem(lParam.iSubItem) : null;
        ...
        public virtual OlvListViewHitTestInfo OlvHitTest(int x, int y)
        {
            ...
            if (hti.Item == null && !this.FullRowSelect && this.View == System.Windows.Forms.View.Details)
            {
                ...
                Point sides = NativeMethods2.GetScrolledColumnSides(this, 0);
        ...
        protected virtual void CalculateStandardHitTest(OlvListViewHitTestInfo hti, int x, int y)
        {
            ...
            if (this.View != System.Windows.Forms.View.Details || hti.ColumnIndex == 0 ||
        ...
        protected virtual void CalculateOwnerDrawnHitTest(OlvListViewHitTestInfo hti, int x, int y)
        {
            ...
            if (this.View == System.Windows.Forms.View.Details && hti.Column == null)
                return;

            // Which renderer was responsible for drawing that point
            IRenderer renderer = this.View == System.Windows.Forms.View.Details
        ...
        {
            NativeMethods2.SelectAllItems(this);
        }
        ...
        {
            NativeMethods2.SetBackgroundImage(this, image, true, false, 0, 0);
        }
        ...
        {
            NativeMethods2.SetBackgroundImage(this, image, false, false, xOffset, yOffset);
        }
        ...
        {
            NativeMethods2.SetBackgroundImage(this, image, false, true, 0, 0);
        }
        ...
        internal class ObjectListViewState
        {
            ...
            public System.Windows.Forms.View CurrentView;
        ...
        protected virtual bool HandleBeginScroll(ref Message m)
        {
            ...
            NativeMethods2.NMLVSCROLL nmlvscroll = (NativeMethods2.NMLVSCROLL)m.GetLParam(typeof(NativeMethods2.NMLVSCROLL));
            if (nmlvscroll.dx != 0)
            {
                int scrollPositionH = NativeMethods2.GetScrollPosition(this, true);
            ...
            if (nmlvscroll.dy != 0)
            {
                int scrollPositionV = NativeMethods2.GetScrollPosition(this, false);
        ...
        protected virtual bool HandleLinkClick(ref Message m)
        {
            ...
            NativeMethods2.NMLVLINK nmlvlink = (NativeMethods2.NMLVLINK)m.GetLParam(typeof(NativeMethods2.NMLVLINK));
        ...
        protected virtual bool HandleCustomDraw(ref Message m)
        {
            ...
            NativeMethods2.NMLVCUSTOMDRAW nmcustomdraw = (NativeMethods2.NMLVCUSTOMDRAW)m.GetLParam(typeof(NativeMethods2.NMLVCUSTOMDRAW));
        ...
        protected virtual bool HandleFindItem(ref Message m)
        {
            ...
            NativeMethods2.LVFINDINFO findInfo = (NativeMethods2.LVFINDINFO)m.GetLParam(typeof(NativeMethods2.LVFINDINFO));
        ...
        public virtual int FindMatchingRow(string text, int start, SearchDirectionHint direction)
        {
            ...
            if (this.IsSearchOnSortColumn && this.View == System.Windows.Forms.View.Details && this.PrimarySortColumn != null)
        ...
        {
            NativeMethods2.NMLVGROUP nmlvgroup = (NativeMethods2.NMLVGROUP)m.GetLParam(typeof(NativeMethods2.NMLVGROUP));
        ...
        protected virtual bool HandleKeyDown(ref Message m)
        {
            ...
            int newScrollPositionH = NativeMethods2.GetScrollPosition(this, true);
            int newScrollPositionV = NativeMethods2.GetScrollPosition(this, false);
        ...
        protected virtual bool HandleReflectNotify(ref Message m)
        {
            ...
            NativeMethods2.NMHDR nmhdr = (NativeMethods2.NMHDR)m.GetLParam(typeof(NativeMethods2.NMHDR));
            ...
            switch (nmhdr.code)
            {
                ...
                case LVN_GETINFOTIP:
                    ...
                    NativeMethods2.NMLVGETINFOTIP nmGetInfoTip = (NativeMethods2.NMLVGETINFOTIP)m.GetLParam(typeof(NativeMethods2.NMLVGETINFOTIP));
                ...
                case LVN_ITEMCHANGED:
                    ...
                    NativeMethods2.NMLISTVIEW nmlistviewPtr2 = (NativeMethods2.NMLISTVIEW)m.GetLParam(typeof(NativeMethods2.NMLISTVIEW));
                            ...
                            if (isSelected)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (olvi != null && !olvi.Enabled)
                                        NativeMethods2.DeselectOneItem(this, nmlistviewPtr2.iItem);
                                }
                            }
                        }
                    }
                ...
                case LVN_ITEMCHANGING:
                    ...
                    NativeMethods2.NMLISTVIEW nmlistviewPtr = (NativeMethods2.NMLISTVIEW)m.GetLParam(typeof(NativeMethods2.NMLISTVIEW));
        ...
        protected bool HandleNotify(ref Message m)
        {
            ...
            NativeMethods2.NMHEADER nmheader = (NativeMethods2.NMHEADER)m.GetLParam(typeof(NativeMethods2.NMHEADER));
            ...
            switch (nmheader.nhdr.code)
            {
                ...
                case HDN_TRACKW:
                    if (nmheader.iItem >= 0 && nmheader.iItem < this.Columns.Count)
                    {
                        NativeMethods2.HDITEM hditem = (NativeMethods2.HDITEM)Marshal.PtrToStructure(nmheader.pHDITEM, typeof(NativeMethods2.HDITEM));
                        OLVColumn column = this.GetColumn(nmheader.iItem);
                ...
                case HDN_ITEMCHANGINGW:
                    nmheader = (NativeMethods2.NMHEADER)m.GetLParam(typeof(NativeMethods2.NMHEADER));
                    if (nmheader.iItem >= 0 && nmheader.iItem < this.Columns.Count)
                    {
                        NativeMethods2.HDITEM hditem = (NativeMethods2.HDITEM)Marshal.PtrToStructure(nmheader.pHDITEM, typeof(NativeMethods2.HDITEM));
                        OLVColumn column = this.GetColumn(nmheader.iItem);
        ...
        protected virtual bool HandleWindowPosChanging(ref Message m)
        {
            ...
            NativeMethods2.WINDOWPOS pos = (NativeMethods2.WINDOWPOS)m.GetLParam(typeof(NativeMethods2.WINDOWPOS));
        ...
        /// </summary>
        static public Bitmap SortAscendingImage = SparkControls.Properties.Resources.ÕýÐò;

        /// <summary>
        /// Gets or sets the image that will be placed next to the Sort Descending command
        /// </summary>
        static public Bitmap SortDescendingImage = SparkControls.Properties.Resources.µ¹Ðò;
        ...
        public virtual void EnsureGroupVisible(ListViewGroup lvg)
        {
            ...
            if (groupIndex <= 0)
            {
                ...
                int delta = 0 - NativeMethods2.GetScrollPosition(this, false);
                NativeMethods2.Scroll(this, 0, delta);
            }
            else
            {
        ...
        protected virtual void ShowSortIndicator(OLVColumn columnToSort, SortOrder sortOrder)
        {
            ...
            if (!NativeMethods2.HasBuiltinSortIndicators())
            {
            ...
            for (int i = 0; i < this.Columns.Count; i++)
            {
                if (columnToSort != null && i == columnToSort.Index)
                    NativeMethods2.SetColumnImage(this, i, sortOrder, imageIndex);
                else
                    NativeMethods2.SetColumnImage(this, i, SortOrder.None, -1);
            }
        }
        ...
        protected virtual void ForceSubItemImagesExStyle()
        {
            ...
            if (!this.VirtualMode)
                NativeMethods2.ForceSubItemImagesExStyle(this);
        }
...
#pragma warning restore 168
        ...
        {
            if (this.UseAlternatingBackColors && this.View == System.Windows.Forms.View.Details && olvi.Enabled)
            {
                olvi.UseItemStyleForSubItems = true;
        ...
        public virtual void SetSubItemImage(int rowIndex, int subItemIndex, OLVListSubItem subItem, bool shouldClearImages)
        {
            ...
            if (shouldClearImages || imageIndex != -1)
                NativeMethods2.SetSubItemImage(this, rowIndex, subItemIndex, imageIndex);
        }
        ...
        protected virtual void OnControlCreated()
        {
            ...
            NativeMethods2.SetGroupImageList(this, this.GroupImageList);
        ...
        public virtual Rectangle CalculateColumnVisibleBounds(Rectangle bounds, OLVColumn column)
        {
            ...
            Point sides = NativeMethods2.GetScrolledColumnSides(this, column.Index);
            if (sides.X == -1)
                return Rectangle.Empty;
        ...
        protected virtual void UpdateHotItem(OlvListViewHitTestInfo hti)
        {
            ...
            if (newHotRow >= 0 && this.View != System.Windows.Forms.View.Details)
                newHotColumn = 0;
        ...
        protected virtual void ApplyCellStyle(OLVListItem olvi, int columnIndex, IItemStyle style)
        {
            ...
            if (this.View != System.Windows.Forms.View.Details && columnIndex > 0)
                return;
