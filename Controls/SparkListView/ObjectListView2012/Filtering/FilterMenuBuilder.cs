...
namespace SparkControls {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public Bitmap ClearFilterImage = SparkControls.Properties.Resources.ClearFilter;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilterImage = SparkControls.Properties.Resources.筛选;
        ...
        virtual protected ToolStripMenuItem CreateFilteringMenuItem(OLVColumn column, List<ICluster> clusters) {
            ...
            ToolStripMenuItem clearAll = new ToolStripMenuItem(CLEAR_ALL_FILTERS_LABEL, ClearFilterImage, delegate(object sender, EventArgs args) {
                this.ClearAllFilters(column);
            });
            ToolStripMenuItem apply = new ToolStripMenuItem(APPLY_LABEL, FilterImage, delegate(object sender, EventArgs args) {
