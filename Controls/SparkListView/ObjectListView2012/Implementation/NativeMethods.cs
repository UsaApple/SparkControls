...
namespace SparkControls
{
    ...
    internal static class NativeMethods2
    {
        ...
        {
            public NativeMethods2.NMHDR nmcd;
            public int dwDrawStage;
            public IntPtr hdc;
            public NativeMethods2.RECT rc;
        ...
        {
            public NativeMethods2.NMHDR hdr;
            public int iItem;
            public int iSubItem;
        ...
        {
            public NativeMethods2.NMCUSTOMDRAW nmcd;
            public int clrText;
            ...
            public int iPartId;
            public int iStateId;
            public NativeMethods2.RECT rcText;
            public uint uAlign;
        }
        ...
        public struct NMLVFINDITEM
        {
            public NativeMethods2.NMHDR hdr;
            public int iStart;
            public NativeMethods2.LVFINDINFO lvfi;
        }
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(NativeMethods2.SCROLLINFO));
            public int fMask;
            public int nMin;
            public int nMax;
            public int nPage;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(NativeMethods2.TOOLINFO));
            public int uFlags;
            public IntPtr hwnd;
            public IntPtr uId;
            public NativeMethods2.RECT rect;
        ...
        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern IntPtr SendMessageTOOLINFO(IntPtr hWnd, int Msg, int wParam, NativeMethods2.TOOLINFO lParam);
        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern IntPtr SendMessageLVBKIMAGE(IntPtr hWnd, int Msg, int wParam, ref NativeMethods2.LVBKIMAGE lParam);
        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        ...
        public static bool SetBackgroundImage(ListView lv, Image image, bool isWatermark, bool isTiled, int xOffset, int yOffset) {
            ...
            IntPtr result = NativeMethods2.SendMessageLVBKIMAGE(lv.Handle, LVM_SETBKIMAGE, 0, ref lvbkimage);
            lvbkimage.ulFlags = LVBKIF_SOURCE_HBITMAP;
            result = NativeMethods2.SendMessageLVBKIMAGE(lv.Handle, LVM_SETBKIMAGE, 0, ref lvbkimage);
        ...
        public static void SetColumnImage(ListView list, int columnIndex, SortOrder order, int imageIndex) {
            IntPtr hdrCntl = NativeMethods2.GetHeaderControl(list);
        ...
        public static void SelectAllItems(ListView list) {
            NativeMethods2.SetItemState(list, -1, LVIS_SELECTED, LVIS_SELECTED);
        }
        ...
        public static void DeselectAllItems(ListView list) {
            NativeMethods2.SetItemState(list, -1, LVIS_SELECTED, 0);
        }
        ...
        public static void DeselectOneItem(ListView list, int index) {
            NativeMethods2.SetItemState(list, index, LVIS_SELECTED, 0);
        }
        ...
        public static Point GetColumnSides(ObjectListView lv, int columnIndex) {
            ...
            IntPtr hdr = NativeMethods2.GetHeaderControl(lv);
            if (hdr == IntPtr.Zero)
                return new Point(-1, -1);

            RECT r = new RECT();
            NativeMethods2.SendMessageRECT(hdr, HDM_GETITEMRECT, columnIndex, ref r);
        ...
        public static Point GetScrolledColumnSides(ListView lv, int columnIndex) {
            ...
            RECT r = new RECT();
            IntPtr result = NativeMethods2.SendMessageRECT(hdr, HDM_GETITEMRECT, columnIndex, ref r);
            int scrollH = NativeMethods2.GetScrollPosition(lv, true);
        ...
        public static int GetColumnUnderPoint(IntPtr handle, Point pt) {
            ...
            return NativeMethods2.HeaderControlHitTest(handle, pt, HHT_ONHEADER | HHT_ONDIVIDER);
        }
        ...
        private static int HeaderControlHitTest(IntPtr handle, Point pt, int flag) {
            ...
            testInfo.pt_x = pt.X;
            testInfo.pt_y = pt.Y;
            IntPtr result = NativeMethods2.SendMessageHDHITTESTINFO(handle, HDM_HITTEST, IntPtr.Zero, testInfo);
        ...
        public static int GetDividerUnderPoint(IntPtr handle, Point pt) {
            const int HHT_ONDIVIDER = 4;
            return NativeMethods2.HeaderControlHitTest(handle, pt, HHT_ONDIVIDER);
        }
        ...
        public static bool ChangeZOrder(IWin32Window toBeMoved, IWin32Window reference) {
            return NativeMethods2.SetWindowPos(toBeMoved.Handle, reference.Handle, 0, 0, 0, 0, SWP_ZORDERONLY);
        }
        ...
        public static bool MakeTopMost(IWin32Window toBeMoved) {
            ...
            return NativeMethods2.SetWindowPos(toBeMoved.Handle, HWND_TOPMOST, 0, 0, 0, 0, SWP_ZORDERONLY);
        }
        ...
        public static bool ChangeSize(IWin32Window toBeMoved, int width, int height) {
            return NativeMethods2.SetWindowPos(toBeMoved.Handle, IntPtr.Zero, 0, 0, width, height, SWP_SIZEONLY);
        }
        ...
        static public void ShowWithoutActivate(IWin32Window win) {
            ...
            NativeMethods2.ShowWindow(win.Handle, SW_SHOWNA);
        }
        ...
        static public void SetSelectedColumn(ListView objectListView, ColumnHeader value) {
            NativeMethods2.SendMessage(objectListView.Handle,
        ...
        static public bool HasHorizontalScrollBar(ListView lv) {
            ...
            return (NativeMethods2.GetWindowLong(lv.Handle, GWL_STYLE) & WS_HSCROLL) != 0;
        }
        ...
        public static int GetGroupInfo(ObjectListView olv, int groupId, ref LVGROUP2 group) {
            return (int)NativeMethods2.SendMessage(olv.Handle, LVM_GETGROUPINFO, groupId, ref group);
        }

        public static GroupState GetGroupState(ObjectListView olv, int groupId, GroupState mask) {
            return (GroupState)NativeMethods2.SendMessage(olv.Handle, LVM_GETGROUPSTATE, groupId, (int)mask);
        }

        public static int InsertGroup(ObjectListView olv, LVGROUP2 group) {
            return (int)NativeMethods2.SendMessage(olv.Handle, LVM_INSERTGROUP, -1, ref group);
        }

        public static int SetGroupInfo(ObjectListView olv, int groupId, LVGROUP2 group) {
            return (int)NativeMethods2.SendMessage(olv.Handle, LVM_SETGROUPINFO, groupId, ref group);
        }

        public static int SetGroupMetrics(ObjectListView olv, LVGROUPMETRICS metrics) {
            return (int)NativeMethods2.SendMessage(olv.Handle, LVM_SETGROUPMETRICS, 0, ref metrics);
        }

        public static void ClearGroups(VirtualObjectListView virtualObjectListView) {
            NativeMethods2.SendMessage(virtualObjectListView.Handle, LVM_REMOVEALLGROUPS, 0, 0);
        }
        ...
        public static void SetGroupImageList(ObjectListView olv, ImageList il) {
            ...
            if (il != null)
                handle = il.Handle;
            NativeMethods2.SendMessage(olv.Handle, LVM_SETIMAGELIST, LVSIL_GROUPHEADER, handle);
        }

        public static int HitTest(ObjectListView olv, ref LVHITTESTINFO hittest)
        {
            return (int)NativeMethods2.SendMessage(olv.Handle, olv.View == System.Windows.Forms.View.Details ? LVM_SUBITEMHITTEST : LVM_HITTEST, -1, ref hittest);
        }
    }
}
