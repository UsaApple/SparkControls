...
namespace SparkControls.Controls
{
	...
	public class SparkSplitter : Splitter, ISparkTheme<SparkSplitterTheme>
	{
		...
		/// 构造方法
		/// </summary>
		public SparkSplitter()
		{
			base.Font = Consts.DEFAULT_FONT;
			this.Theme = new SparkSplitterTheme(this);
		}
		...
		public SparkSplitterTheme Theme { get; private set; }
