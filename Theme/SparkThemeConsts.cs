...
{
    /// <summary>
    /// 主题常量值，默认颜色不能设置为16进制，必须设置为RGB或者颜色英文单词
    /// </summary>
    public static class SparkThemeConsts
    {
        #region Base
        ...
        internal const string FormBorderColorString = "51,102,255";
        #endregion
        ...
        internal const string MouseDownBackColorString = "202,243,226";
        internal const string SelectedBackColorString = "51,204,255";

        internal const string MouseOverBorderColorString = "223,223,223";
        internal const string MouseDownBorderColorString = "202,243,226";
        internal const string SelectedBorderColorString = "51,102,255";
        ...
        internal const string DisabledBackColorString = "240,240,240";
        #endregion
        ...
        internal const string TextBoxMouseOverBorderColorString = "51,102,255";
        internal const string TextBoxMouseDownBorderColorString = "51,102,255";
        ...
        internal const string ButtonMouseDownBackColorString = "51,204,255";
        internal const string ButtonSelectedBackColorString = "51,204,255";

        internal const string ButtonMouseOverBorderColorString = "51,102,255";
        internal const string ButtonMouseDownBorderColorString = "51,102,255";
        internal const string ButtonSelectedBorderColorString = "51,102,255";

        internal const string ButtonMouseOverForeColorString = "51,102,255";
        ...
        internal const string CheckBoxTickColorString = "51,102,255";
        internal const string CheckBoxIndeterminateBackColorString = "202,243,226";
        internal const string CheckBoxFocusedBorderColorString = "51,102,255";
        ...
        internal const string CheckBoxMouseDownBorderColorString = "51,204,255";
        internal const string CheckBoxSelectedBorderColorString = "51,204,255";
        ...
        internal const string CombinedCheckBoxBackColorString = "51,204,255";
        #endregion
        ...
        internal const string RadioButtonCentreForeColorString = "51,102,255";
        internal const string RadioButtonFocusedBorderColorString = "51,102,255";
        #endregion
        ...
        internal const string ComboBoxButtonForeColorString = "51,102,255";
        internal const string ComboBoxButtonBackColorString = "White";

        internal const string ComboBoxMouseOverBorderColorString = "51,102,255";
        internal const string ComboBoxMouseDownBorderColorString = "51,102,255";
        #endregion
        ...
        internal const string DateTimePickerMouseOverBorderColorString = "51,204,255";
        internal const string DateTimePickerMouseDownBorderColorString = "51,204,255";
        internal const string DateTimePickerSelectColorString = "51,204,255";
        #endregion
        ...
        internal const string GroupBackColorString = "51,102,255";
        internal const string GroupBorderColorString = "51,102,255";
        #endregion

        #region Line
        internal static readonly Color LineBorderColor = ColorTranslator.FromHtml(LineBorderColorString);
        internal const string LineBorderColorString = "Black";
        #endregion
        ...
        internal static readonly Color TabSplitLineColor = ColorTranslator.FromHtml(TabSplitLineColorString);
        internal static readonly Color TabSelectedSplitLineColor = ColorTranslator.FromHtml(TabSelectedSplitLineColorString);

        internal const string TabMouseOverBackColorString = "202,243,226";

        internal const string TabSelectedBottomBorderColorString = "51,102,255";
        internal const string TabBackColorString = "Control";
        internal const string TabBorderColorString = "Transparent";

        internal const string TabForeColorString = "61,61,61";
        internal const string TabSelectedBackColorString = "Control";
        internal const string TabSelectedBorderColorString = "Transparent";

        internal const string TabSelectedForeColorString = "61,61,61";

        internal const string TabSplitLineColorString = "Transparent";
        internal const string TabSelectedSplitLineColorString = "Transparent";
        ...
        internal const string TitleBackColorString = "51,102,255";
        internal const string TitleBorderColorString = "Transparent";
        internal const string TitleForeColorString = "255,255,255";
        internal const string TitleMouseOverBackColorString = "202,243,226";
        internal const string TitleMouseDownBackColorString = "202,243,226";
        #endregion
        ...
        internal const string ToolStripMouseOverBackColorString = "202,243,226";
        internal const string ToolStripMouseDownBackColorString = "202,243,226";
        internal const string ToolStripSelectedBackColorString = "51,102,255";
        #endregion

        #region TreeView 
        internal static readonly Color TreeViewNodeSplitLineColor = ColorTranslator.FromHtml(TreeViewNodeSplitLineColorString);
        internal const string TreeViewNodeSplitLineColorString = "51,102,255";
        #endregion

        #region Splitter
        internal static readonly Color SplitterMouseOverBackColor = ColorTranslator.FromHtml(SplitterMouseOverBackColorString);
        internal const string SplitterMouseOverBackColorString = "51,102,255";

        internal static readonly Color SplitterHandlerBackColor = ColorTranslator.FromHtml(SplitterHandlerBackColorString);
        internal const string SplitterHandlerBackColorString = "51,204,255";
        #endregion
        ...
        internal const string NavigationBarTitleFontColorString = "51,102,255";
        internal const string NavigationBarBackColorString = "255,255,255";
        internal const string NavigationBarToolBackColorString = "51,102,255";
        internal const string NavigationBarToolSelectedColorString = "White";
        #endregion
    }
}