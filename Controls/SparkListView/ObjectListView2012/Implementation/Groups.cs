...
namespace SparkControls
{
    ...
    public class OLVGroup
    {
        ...
        public void InsertGroupNewStyle(ObjectListView olv) {
            this.ListView = olv;
            NativeMethods2.InsertGroup(olv, this.AsNativeGroup(true));
        }
        ...
        public void InsertGroupOldStyle(ObjectListView olv) {
            ...
            NativeMethods2.SetGroupInfo(olv, this.GroupId, this.AsNativeGroup(false));
        }
        ...
        /// </summary>
        internal NativeMethods2.LVGROUP2 AsNativeGroup(bool withId) {

            NativeMethods2.LVGROUP2 group = new NativeMethods2.LVGROUP2();
            group.cbSize = (uint)Marshal.SizeOf(typeof(NativeMethods2.LVGROUP2));
        ...
        protected GroupState GetState() {
            return NativeMethods2.GetGroupState(this.ListView, this.GroupId, GroupState.LVGS_ALL);
        }
        ...
        protected int SetState(GroupState newState, GroupState mask) {
            ...
            return NativeMethods2.SetGroupInfo(this.ListView, this.GroupId, group);
        }
