...
using SparkControls.Properties;
...
namespace SparkControls {
    ...
    public class HeaderControl : NativeWindow {
        ...
        public HeaderControl(ObjectListView olv) {
            this.ListView = olv;
            this.AssignHandle(NativeMethods2.GetHeaderControl(olv));
        }
        ...
        public int ColumnIndexUnderCursor {
            get {
                ...
                return NativeMethods2.GetColumnUnderPoint(this.Handle, pt);
            }
        }
        ...
        public new IntPtr Handle {
            get { return NativeMethods2.GetHeaderControl(this.ListView); }
        }
        ...
        protected int GetColumnCheckBoxUnderCursor() {
            ...
            int columnIndex = NativeMethods2.GetColumnUnderPoint(this.Handle, pt);
        ...
        public Rectangle ClientRectangle {
            get {
                ...
                NativeMethods2.GetClientRect(this.Handle, ref r);
                return r;
            }
        }
        ...
        protected bool IsCursorOverLockedDivider {
            get {
                Point pt = this.ScrolledCursorPosition;
                int dividerIndex = NativeMethods2.GetDividerUnderPoint(this.Handle, pt);
        ...
        public Rectangle GetItemRect(int itemIndex) {
            ...
            NativeMethods2.RECT r = new NativeMethods2.RECT();
            NativeMethods2.SendMessageRECT(this.Handle, HDM_GETITEMRECT, itemIndex, ref r);
        ...
        public void Invalidate() {
            NativeMethods2.InvalidateRect(this.Handle, 0, true);
        }
        ...
        public void Invalidate(OLVColumn column) {
            NativeMethods2.InvalidateRect(this.Handle, 0, true); // todo
        }
        ...
        internal virtual bool HandleHeaderCustomDraw(ref Message m) {
            ...
            NativeMethods2.NMCUSTOMDRAW nmcustomdraw = (NativeMethods2.NMCUSTOMDRAW) m.GetLParam(typeof (NativeMethods2.NMCUSTOMDRAW));
            ...
            switch (nmcustomdraw.dwDrawStage) {
                ...
                case CDDS_ITEMPREPAINT:
                    ...
                    if (this.cachedNeedsCustomDraw) {
                        ...
                        NativeMethods2.SelectObject(nmcustomdraw.hdc, this.fontHandle);
                ...
                case CDDS_ITEMPOSTPAINT:
                    if (this.fontHandle != IntPtr.Zero) {
                        NativeMethods2.DeleteObject(this.fontHandle);
        ...
        protected bool HandleLayout(ref Message m) {
            ...
            NativeMethods2.HDLAYOUT hdlayout = (NativeMethods2.HDLAYOUT) m.GetLParam(typeof (NativeMethods2.HDLAYOUT));
            NativeMethods2.RECT rect = (NativeMethods2.RECT) Marshal.PtrToStructure(hdlayout.prc, typeof (NativeMethods2.RECT));
            NativeMethods2.WINDOWPOS wpos = (NativeMethods2.WINDOWPOS) Marshal.PtrToStructure(hdlayout.pwpos, typeof (NativeMethods2.WINDOWPOS));
            ...
            using (Graphics g = this.ListView.CreateGraphics()) {
                ...
                wpos.flags = NativeMethods2.SWP_FRAMECHANGED;
                wpos.x = rect.left;
                wpos.y = rect.top;
        ...
        private int CalculateFilterIndicatorWidth(Rectangle r) {
            if (Resources.筛选 == null || r.Width < 48)
                return 0;
            return Resources.筛选.Width + 1;
        }
        ...
        internal OlvListViewHitTestInfo.HeaderHitTestInfo HitTest(int x, int y)
        {
            ...
            hti.ColumnIndex = NativeMethods2.GetColumnUnderPoint(this.Handle, pt);
            hti.IsOverCheckBox = this.IsPointOverHeaderCheckBox(hti.ColumnIndex, pt);
            hti.OverDividerIndex = NativeMethods2.GetDividerUnderPoint(this.Handle, pt);
