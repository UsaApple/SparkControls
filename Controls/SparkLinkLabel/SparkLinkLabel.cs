...
namespace SparkControls.Controls
{
	...
	public class SparkLinkLabel : LinkLabel, ISparkTheme<SparkLinkLabelTheme>
	{
		...
		/// 构造方法
		/// </summary>
		public SparkLinkLabel()
		{
			base.Font = Consts.DEFAULT_FONT;
			this.Theme = new SparkLinkLabelTheme(this);
		}
		...
		public SparkLinkLabelTheme Theme { get; private set; }
