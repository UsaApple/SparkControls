...
{
    [ToolboxBitmap(typeof(SparkControls.Controls.SparkToolBoxBitmap.Line), "TcLineH.bmp")]
    public class SparkLineH : Control, ISparkTheme<SparkLineTheme>
    {
        public SparkLineH() : base()
        {
        ...
        {
            //int boundY = y < this.Location.Y ? this.Location.Y : y;
            base.SetBoundsCore(x, y, width, this.LineWidth, specified);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                e.Graphics.DrawLine(p, this.Location, new Point(this.Location.X + this.LineLong, this.Location.Y));
            }
        }
        ...
        public int LineWidth
        {
            ...
            set
            {
                base.Height = this.mLineWidth = value;
                base.Invalidate();
            }
        }
        ...
        {
            get => base.Size;
            set { base.Width = value.Width; base.Height = LineWidth; }
        }
