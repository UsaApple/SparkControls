    ...
    public class Generator : IGenerator {
        ...
        public virtual IList<OLVColumn> GenerateColumns(Type type, bool allProperties) {
            ...
            foreach (PropertyInfo pinfo in type.GetProperties()) {
                if (System.Attribute.GetCustomAttribute(pinfo, typeof(OLVIgnoreAttribute)) != null)
                    continue;

                OLVColumnAttribute attr = System.Attribute.GetCustomAttribute(pinfo, typeof(OLVColumnAttribute)) as OLVColumnAttribute;
                if (attr == null) {
                    if (allProperties)
        ...
        protected virtual void TryGenerateChildrenDelegates(TreeListView tlv, Type type) {
            foreach (PropertyInfo pinfo in type.GetProperties()) {
                OLVChildrenAttribute attr = System.Attribute.GetCustomAttribute(pinfo, typeof(OLVChildrenAttribute)) as OLVChildrenAttribute;
                if (attr != null) {
