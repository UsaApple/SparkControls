...
namespace SparkControls
{
    ...
    internal interface IOwnerDataCallback
    {
        ...
        /// <param name="i"></param>
        /// <param name="pt"></param>
        void GetItemPosition(int i, out NativeMethods2.POINT pt);
        ...
        /// <param name="t"></param>
        /// <param name="pt"></param>
        void SetItemPosition(int t, NativeMethods2.POINT pt);
        ...
        /// <param name="i"></param>
        /// <param name="j"></param>
        void OnCacheHint(NativeMethods2.LVITEMINDEX i, NativeMethods2.LVITEMINDEX j);
    }
    ...
    internal class OwnerDataCallbackImpl : IOwnerDataCallback
    {
        ...
        public void GetItemPosition(int i, out NativeMethods2.POINT pt) {
            //System.Diagnostics.Debug.WriteLine("GetItemPosition");
            throw new NotSupportedException();
        }

        public void SetItemPosition(int t, NativeMethods2.POINT pt) {
        ...
        public void OnCacheHint(NativeMethods2.LVITEMINDEX from, NativeMethods2.LVITEMINDEX to) {
